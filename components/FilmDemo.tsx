...
const scenesPublic: InformationsFilmScen[] = [
  ...
  {
    titel: "Se filmerna — få prisuppgift",
    text: "Korta scener visar hur modulerna fungerar. När ni sett filmen får ni tydlig prisbild och kan välja provperiod eller avtal.",
  },
  {
          ...
          <div className="bg-primary-dark p-6 text-white sm:p-8">
            ...
            <h2 className="mt-3 text-2xl font-bold sm:text-3xl">
              {isForening
                ...
                : "Se filmerna — förstå funktionerna, få prisuppgift"}
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-white/85">
              {isForening
                ...
                : "Korta scener visar underhållsplan och upphandling i praktiken. När ni sett filmen vet ni vad plattformen kostar och kan starta 30 dagars gratis provperiod."}
            </p>
            {isForening ? (
              <Link
          ...
          <div className="p-4 sm:p-6">
            ...
            <p className="mt-3 text-center text-xs text-muted">
              {isForening
                ...
                : "Demo utan ljud — efter filmen får ni prisuppgift och kan välja provperiod eller avtal."}
            </p>
          </div>
        </div>
      </div>
